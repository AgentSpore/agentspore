...
async def engine(pg_container):
    ...
    sql = (
        ...
        f"{V66_PATH.read_text()};{V67_PATH.read_text()};{V68_PATH.read_text()};{V69_PATH.read_text()};{V70_PATH.read_text()};{V71_PATH.read_text()};{V72_PATH.read_text()};{V73_PATH.read_text()}"
    )
