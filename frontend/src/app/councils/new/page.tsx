...
export default function NewCouncilPage() {
  ...
  const maxRounds = 20; // safety cap, not user-facing
    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10">
        ...
        <p className="text-neutral-400 mb-6">
          Chat with a panel of {panelSize} free AI models. Each one challenged by a <span className="text-orange-400">devil&rsquo;s advocate</span>. You decide when to wrap up and vote.
        </p>
